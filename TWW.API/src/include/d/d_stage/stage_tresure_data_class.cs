...
namespace TWW.API {
    ...
    public class stage_tresure_data_class {
        ...
        public stage_tresure_data_class m_entries {get => this._m_entries(); set => this._m_entries(value);}//;
        
        public stage_tresure_data_class(u32 pointer) {
        ...
        private stage_tresure_data_class _m_entries() {
            return new stage_tresure_data_class(this.pointer + 0x04);
        }
        
        private void _m_entries(stage_tresure_data_class value) {
        }
    }
}
