...
namespace TWW.API {
    ...
    public class dSv_turnRestart_c {
        ...
        private u8[] _field_0x14() {
            u8[] bytes = new u8[16]; for(u32 i = 0; i < 16; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x14 + (i * 1));} return bytes;
        }
        
        private void _field_0x14(u8[] value) {
            for(u32 i = 0; i < 16; i++){Memory.RAM.WriteU8(this.pointer + 0x14 + (i * 1), value[i]);}
        }
