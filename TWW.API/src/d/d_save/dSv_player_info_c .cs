...
namespace TWW.API {
    ...
    public class dSv_player_info_c  {
        ...
        private @char[] _mPlayerName() {
            @char[] bytes = new @char[17]; for(u32 i = 0; i < 17; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x14 + (i * 1));} return bytes;
        }
        
        private void _mPlayerName(@char[] value) {
            for(u32 i = 0; i < 17; i++){Memory.RAM.WriteU8(this.pointer + 0x14 + (i * 1), value[i]);}
        }
        
        // #ARRCOUNT 17
        private @char[] _field_0x25() {
            @char[] bytes = new @char[17]; for(u32 i = 0; i < 17; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x25 + (i * 1));} return bytes;
        }
        
        private void _field_0x25(@char[] value) {
            for(u32 i = 0; i < 17; i++){Memory.RAM.WriteU8(this.pointer + 0x25 + (i * 1), value[i]);}
        }
        
        // #ARRCOUNT 17
        private @char[] _field_0x36() {
            @char[] bytes = new @char[17]; for(u32 i = 0; i < 17; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x36 + (i * 1));} return bytes;
        }
        
        private void _field_0x36(@char[] value) {
            for(u32 i = 0; i < 17; i++){Memory.RAM.WriteU8(this.pointer + 0x36 + (i * 1), value[i]);}
        }
        
        // #ARRCOUNT 17
        private @char[] _field_0x47() {
            @char[] bytes = new @char[17]; for(u32 i = 0; i < 17; i++){bytes[i] = Memory.RAM.ReadU8(this.pointer + 0x47 + (i * 1));} return bytes;
        }
        
        private void _field_0x47(@char[] value) {
            for(u32 i = 0; i < 17; i++){Memory.RAM.WriteU8(this.pointer + 0x47 + (i * 1), value[i]);}
        }
